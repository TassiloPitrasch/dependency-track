...
public class ProjectTest extends PersistenceCapableTest {
    ...
    public void testProjectPersistence() {
        Project p1 = qm.createProject("Example Project 1", "Description 1", "1.0", null, null, null, Project.EnhancedStatus.IN_DEVELOPMENT, false);
        Project p2 = qm.createProject("Example Project 2", "Description 2", "1.1", null, null, null, Project.EnhancedStatus.IN_DEVELOPMENT, false);
    ...
    public void testProjectPersistActiveFieldDefaultsToTrue() {
        ...
        Assert.assertNotNull(persistedProject.getEnhancedStatus());
        Assert.assertEquals(Project.EnhancedStatus.IN_DEVELOPMENT, persistedProject.getEnhancedStatus());
    }
}
